    ...
    users.forEach(user => {
      ...
      if (state === 'flagged') {
        ...
        svg.append('text')
          ...
          .attr('font-size', '12px').attr('font-weight', '500').attr('fill', '#333')
          .attr('pointer-events', 'none')
          .text('?');
      }
...
function drawPyramid(raw, sel) {
  ...
  svg.append('text').attr('x', midX - 10).attr('y', -8).attr('text-anchor', 'end')
    .attr('fill', '#1a5276').attr('font-family', "'DM Mono', monospace").attr('font-size', '12px').attr('font-weight', '500')
    .text('Male');
  svg.append('text').attr('x', midX + 10).attr('y', -8)
    .attr('fill', '#E69F00').attr('font-family', "'DM Mono', monospace").attr('font-size', '12px').attr('font-weight', '500')
    .text('Female');
